              ...
              <div className='row center-align'>
                <div className='col-md-5' id='person'>
                  <div className='feature'>
                    ...
                    <a href='https://www.linkedin.com/in/bryanrkelley14/' target='_blank' rel='noopener noreferrer'><button className='btn waves-effect waves-light'>LinkedIn<i className='material-icons left' title=''>people</i></button></a>
                  </div>
                </div>
                ...
                <div className='col-md-5' id='person'>
                  <div className='feature'>
                    ...
                    <a href='https://www.linkedin.com/in/nwhite22/' target='_blank' rel='noopener noreferrer'><button className='btn waves-effect waves-light'>LinkedIn<i className='material-icons left' title=''>people</i></button></a>
                  </div>
                </div>
                ...
                <div className='col-md-5' id='person'>
                  <div className='feature'>
                    ...
                    <a href='https://www.linkedin.com/in/naomi-woodruff-162450173/' target='_blank' rel='noopener noreferrer'><button className='btn waves-effect waves-light'>LinkedIn<i className='material-icons left' title=''>people</i></button></a>
                  </div>
                </div>
                ...
                <div className='col-md-5' id='person'>
                  <div className='feature'>
                    ...
                    <a href='https://www.linkedin.com/in/catherinephamcww/' target='_blank' rel='noopener noreferrer'><button className='btn waves-effect waves-light'>LinkedIn<i className='material-icons left' title=''>people</i></button></a>
                  </div>
                </div>
              </div>
            </div>
